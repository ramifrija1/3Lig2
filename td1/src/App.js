...
import './App.css';
import Pictogramme from './compenents/Pictogramme';
import Commentaire from './compenents/Commentaire';
      ...
      <div class="col-6 offset-3">
        <div class="card">
          <div class="card-block">
            ...
            <p id="textChange">Bonne découverte des composants React "Components!!!"</p>
